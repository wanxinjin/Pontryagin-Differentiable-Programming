...
for j in range(10):
    ...
    cartpoleoc.recmat_init_step(horizon, -1)
    ...
    for k in range(int(max_iter)):
        ...
        loss, dp = cartpoleoc.recmat_step(ini_state, horizon, current_parameter)
        # update
    ...
    sol = cartpoleoc.recmat_unwarp(ini_state, horizon, current_parameter)
