...
ax.set_ylim(bottom=1e-10,top=1e6)
...
line_dmd,=ax.plot(dmd_loss_list[0][1:], marker='v', markevery=1000, color=[0.9290, 0.6940, 0.1250], linewidth=4, markersize=10)
...
ax.legend([line_pdp, line_dmd, line_nn], ['PDP', 'DMDc', 'NN dynamics'], facecolor='white', framealpha=0.5)
plt.show()
