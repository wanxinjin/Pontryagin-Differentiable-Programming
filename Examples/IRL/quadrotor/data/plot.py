...
for kkt_loss, pdp_loss, nn_loss in zip(kkt_loss_list, pdp_loss_list, nn_loss_list):
    ax.plot(pdp_loss[1:], marker='o', markevery=1000, color = [0.6350, 0.0780, 0.1840], linewidth=4, markersize=10)
...
# show legend
line_pdp,=ax.plot(pdp_loss_list[0][1:], marker='o', markevery=1000, color = [0.6350, 0.0780, 0.1840], linewidth=4, markersize=10)
