...
# env.play_animation(wing_len=1.5, state_traj=pdp_sol['state_traj_opt'], state_traj_ref=true_sol['state_traj_opt'])
...
ax = fig.subplots(2,2)
line_gt,=ax[0,0].plot(true_sol['control_traj_opt'][:,0], color ='#0072BD', linewidth=10, linestyle='dashed', alpha=0.7)
line_pdp,=ax[0,0].plot(pdp_sol['control_traj_opt'][:,0], color ='#A2142F', linewidth=5)
line_kkt,=ax[0,0].plot(kkt_sol['control_traj_opt'][:,0], color ='#EDB120', linewidth=5)
line_nn,=ax[0,0].plot(nn_control_traj[0:,0], color ='#77AC30', linewidth=5)
ax[0,0].set_ylabel('Thrust 1')
ax[0,0].set_facecolor('#E6E6E6')
ax[0,0].grid()

ax[0,1].plot(true_sol['control_traj_opt'][:,1], color ='#0072BD', linewidth=10, linestyle='dashed', alpha=0.7)
ax[0,1].plot(pdp_sol['control_traj_opt'][:,1], color ='#A2142F', linewidth=5)
ax[0,1].plot(kkt_sol['control_traj_opt'][:,1], color ='#EDB120', linewidth=5)
ax[0,1].plot(nn_control_traj[:,1], color ='#77AC30', linewidth=5)
ax[0,1].set_ylabel('Torque 2')
...
ax[1,1].set_ylabel('Torque 4')
ax[1,1].set_facecolor('#E6E6E6')
ax[1,1].grid()
ax[1,1].yaxis.set_label_position("right")
ax[1,1].set_xlabel('Time')

fig.suptitle('UAV planning', fontsize=40)

ax[0,1].legend([line_gt, line_pdp, line_kkt, line_nn], ['Ground truth', 'PDP', 'Inverse KKT', 'Neural policy'], facecolor='white', framealpha=0.5,
           loc='best')
plt.show()