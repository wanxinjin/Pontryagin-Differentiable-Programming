...
ax.set_ylim(bottom=1e-9,top=1e4)
...
for kkt_loss, pdp_loss, nn_loss in zip(kkt_loss_list, pdp_loss_list, nn_loss_list):
    ...
    ax.plot(nn_loss[0::10], marker='P', markevery=1000, color=[0.4660, 0.6740, 0.1880], linewidth=4, markersize=10)
# show legend
...
line_nn,=ax.plot(nn_loss_list[0][0::10], marker='P', markevery=1000, color=[0.4660, 0.6740, 0.1880], linewidth=4, markersize=10)
